...
import 'package:baby_names/pages/state.dart';
import 'package:baby_names/services/provider.dart';
        ...
        child: SizedBox(
          ...
          child: new RaisedButton(
            ...
            shape: new RoundedRectangleBorder(
                borderRadius: new BorderRadius.circular(30.0)),
            color: Colors.white,
            child: new Text('SignIn with Facebook',
